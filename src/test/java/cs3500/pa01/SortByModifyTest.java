...
/**
 * Represents tests for SortByModify
 */
class SortByModifyTest {
  ...
  void compare() {
    ...
    FileTime create2 = FileTime.from(Instant.parse("2023-05-12T12:00:00Z"));
    FileTime modify2 = FileTime.from(Instant.parse("2023-05-12T11:00:00Z"));
    FileTime create3 = FileTime.from(Instant.parse("2023-05-12T12:00:00Z"));
    FileTime modify3 = FileTime.from(Instant.parse("2023-05-12T09:00:00Z"));
